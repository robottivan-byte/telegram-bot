...
CONTENT = [
    ...
    "🌿 Притча: Мудрец сказал — не трать слова там, где достаточно взгляда, и не трать взгляд там, где достаточно молчания.",
    "🌿 Притча: Ветер спросил дуб почему тот не сломался. Дуб ответил: я не сопротивлялся — я гнулся.",
    "🌿 Притча: Два волка борются внутри каждого из нас — злой и добрый. Победит тот, которого ты кормишь.",
    "🌿 Притча: Счастье — это не пункт назначения, а способ путешествия.",
